...
export default function MenuItem({ name, price, description }: MenuItemType) {
  ...
  return (
    <div
      ref={ref}
      className={`flex justify-between items-start py-4 border-b border-red-100 transition-all duration-500 ${
